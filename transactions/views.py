...
class DepositMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        send_transactions_email(self.request.user,amount,'Deposit Message','transactions/deposit_email.html')
...
class SendMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self,form):
        ...
        messages.success(
            self.request,
            f'Successfully sent {"{:,.2f}".format(float(amount))}$ to account {recipient_account}.'
        )
...
class LoanRequestView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        send_transactions_email(self.request.user,amount,'Loan Request Message','transactions/loan_request_email.html')
